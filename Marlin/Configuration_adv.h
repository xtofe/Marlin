 ...
 */
  ...
  #define INTERPOLATE       true  // Interpolate X/Y/Z_MICROSTEPS to 256
  ...
  #if AXIS_IS_TMC(X2)
    #define X2_CURRENT      1300
    #define X2_CURRENT_HOME (X2_CURRENT / 3)
    #define X2_MICROSTEPS    16
  ...
  #if AXIS_IS_TMC(Y2)
    #define Y2_CURRENT      1300
    #define Y2_CURRENT_HOME (Y2_CURRENT / 3)
    #define Y2_MICROSTEPS    16
    ...
    #define Z_CURRENT_HOME  (Z_CURRENT / 3)
    #define Z_MICROSTEPS     16
    ...
    #define Z2_CURRENT_HOME (Z2_CURRENT / 3)
    #define Z2_MICROSTEPS    16
    ...
    #define Z3_CURRENT_HOME (Z3_CURRENT / 3)
    #define Z3_MICROSTEPS    16
    ...
    #define Z4_CURRENT_HOME (Z4_CURRENT / 3)
    #define Z4_MICROSTEPS    16
...
//#define ESP3D_WIFISUPPORT   // ESP3D Library WiFi management (https://github.com/luc-github/ESP3DLib)
  ...
  #define WIFI_PWD "Wifi Password" //#define WEBSUPPORT          // Start a webserver (which may include auto-discovery)
